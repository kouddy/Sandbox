...
public class HashTable {
   ...
   *         where an element with key theKey may be inserted provided the hash
   *         table is not full
   */
  ...
  /**
   * insert an element with the specified key overwrite old element if there is
   * already an element with the given key
   * 
